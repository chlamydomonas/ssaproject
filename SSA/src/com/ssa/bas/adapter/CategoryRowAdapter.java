...
public class CategoryRowAdapter extends ArrayAdapter<Application> {
	...
	public CategoryRowAdapter(Activity act, int resource, List<Application> arrayList) {
